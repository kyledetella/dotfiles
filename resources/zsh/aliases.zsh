...
alias code='cd ~/code'
alias init='cd ~/init'
alias console='cd ~/init/cpconsole'
alias cli='cd ~/init/init-cli'
alias csi='cd ~/init/init-csi'
alias lamb='cd ~/init/message-processing-lambda'
alias lapi='cd ~/init/lambda-api-client'
alias csi='cd ~/init/csi'
alias api='cd ~/init/api'
